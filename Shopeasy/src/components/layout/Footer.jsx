        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/products?category=men's clothing" className="text-gray-400 hover:text-white transition">
                  Men's Clothing
                </Link>
              </li>
              <li>
                <Link to="/products?category=women's clothing" className="text-gray-400 hover:text-white transition">
                  Women's Clothing
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/products?category=jewelery" className="text-gray-400 hover:text-white transition">
                  Jewelry
                </Link>
              </li>
            </ul>
